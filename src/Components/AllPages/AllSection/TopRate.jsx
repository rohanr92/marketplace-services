                ...
                <div className='py-20'>
                    ...
                    <div className="flex justify-center p-8" >
                        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5" data-aos="fade-up">
                            ...
                            <div className="bg-white rounded-xl pb-[10px] shadow-md text-center w-[296px] flex flex-col items-center border border-amber-100">
                                <div className="w-[296px] h-[170px] overflow-hidden rounded-lg mb-4 p-[5px]">
                                    <img
                                ...
                                <Link className="py-2 px-5 rounded-full text-sm font-medium transition-colors duration-200 min-w-[120px] bg-gray-100 text-gray-800 hover:bg-yellow-500 cursor-pointer">
                                    View Profile
                                </Link>
                            </div>
